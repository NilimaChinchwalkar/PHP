    ...
    <div class="col-12">
        ...
        <div class="col-xl-6 col-lg-5 col-md-7">
            <div class="card ">
                ...
                <div class="card-body">
                    <form role="form">
                    <label for="radioExample">Name</label>
                    <div class="input-group input-group-outline mb-3">
                        <label class="form-label">Name</label>
                        <input type="text" class="form-control">
                    </div>
                    <div class="form-group">
                    <label for="radioExample">Status</label>
                    
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="radioExample" id="radio1" value="option1">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="radioExample" id="radio2" value="option2">
                    ...
                    <div class="text-center">
                        <button type="button" class="btn btn-lg bg-gradient-dark btn-lg w-50 mt-4 mb-0">Save</button>
                    </div>
                    </form>
                </div>
            </div>
